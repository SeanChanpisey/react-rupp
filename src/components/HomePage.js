...
const HomePage = () => {
            ...
            <div className="card position-relative p-4 border rounded-3">
              ...
              {product.discount && (
                <div className="position-absolute">
                  <p className="bg-primary py-1 px-3 fs-6 text-white rounded-2">{product.discount}% off</p>
                </div>
              )}

              {/* Product Image */}
              <img style={{height:"200px"}} src={product.image} className="img-fluid shadow-sm" alt={product.title} />

              {/* Product Title */}
              <h6 className="mt-4 mb-0 fw-bold">
                <a href={`/product/${product.id}`} aria-label={`View details for ${product.title}`}>
              ...
              <div className="card-concern position-absolute start-0 end-0 d-flex gap-2">
                ...
                <a href="#" className="btn btn-dark" aria-label={`Add ${product.title} to wishlist`}>
  ...
  <section id="limited-offer" className="padding-large" style={{backgroundImage: 'url(images/banner-image-bg-1.jpg)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', height: 800}}>
    <div className="container">
      <div className="row d-flex align-items-center">
        <div className="col-md-6 text-center">
          <div className="image-holder">
            <img src="images/banner-image3.png" className="img-fluid" alt="banner" />
          </div>
        </div>
        <div className="col-md-5 offset-md-1 mt-5 mt-md-0 text-center text-md-start">
      ...
      <div className="row">
          ...
          <div className="featured border rounded-3 p-4">
            ...
            <div className="items-lists">
              <div className="item d-flex">
                <img src="images/product-item2.png" className="img-fluid shadow-sm" alt="product item" />
                <div className="item-content ms-3">
                  <h6 className="mb-0 fw-bold"><a href="index.html">Echoes of the Ancients</a></h6>
              ...
              <div className="item d-flex">
                <img src="images/product-item1.png" className="img-fluid shadow-sm" alt="product item" />
                <div className="item-content ms-3">
                  <h6 className="mb-0 fw-bold"><a href="index.html">The Midnight Garden</a></h6>
                  <div className="review-content d-flex">
                    <p className="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    <div className="rating text-warning d-flex align-items-center">
                      <svg className="star star-fill">
              ...
              <hr />
              <div className="item d-flex">
                <img src="images/product-item3.png" className="img-fluid shadow-sm" alt="product item" />
                <div className="item-content ms-3">
                  <h6 className="mb-0 fw-bold"><a href="index.html">Shadow of the Serpent</a></h6>
                  <div className="review-content d-flex">
                    <p className="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    <div className="rating text-warning d-flex align-items-center">
                      <svg className="star star-fill">
        ...
        <div className="col-md-6 mb-4 mb-lg-0 col-lg-3">
          <div className="latest-items border rounded-3 p-4">
            ...
            <div className="items-lists">
              <div className="item d-flex">
                <img src="images/product-item4.png" className="img-fluid shadow-sm" alt="product item" />
                <div className="item-content ms-3">
                  <h6 className="mb-0 fw-bold"><a href="index.html">Whispering Winds</a></h6>
                  <div className="review-content d-flex">
                    <p className="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    <div className="rating text-warning d-flex align-items-center">
                      <svg className="star star-fill">
              ...
              <hr className="gray-400" />
              <div className="item d-flex">
                <img src="images/product-item5.png" className="img-fluid shadow-sm" alt="product item" />
                <div className="item-content ms-3">
                  <h6 className="mb-0 fw-bold"><a href="index.html">The Forgotten Realm</a></h6>
                  <div className="review-content d-flex">
                    <p className="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    <div className="rating text-warning d-flex align-items-center">
                      <svg className="star star-fill">
              ...
              <hr />
              <div className="item d-flex">
                <img src="images/product-item6.png" className="img-fluid shadow-sm" alt="product item" />
                <div className="item-content ms-3">
                  <h6 className="mb-0 fw-bold"><a href="index.html">Moonlit Secrets</a></h6>
                  <div className="review-content d-flex">
                    <p className="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    <div className="rating text-warning d-flex align-items-center">
                      <svg className="star star-fill">
        ...
        <div className="col-md-6 mb-4 mb-lg-0 col-lg-3">
          <div className="best-reviewed border rounded-3 p-4">
            ...
            <div className="items-lists">
              <div className="item d-flex">
                <img src="images/product-item7.png" className="img-fluid shadow-sm" alt="product item" />
                <div className="item-content ms-3">
                  <h6 className="mb-0 fw-bold"><a href="index.html">The Crystal Key</a></h6>
                  <div className="review-content d-flex">
                    <p className="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    <div className="rating text-warning d-flex align-items-center">
                      <svg className="star star-fill">
              ...
              <hr className="gray-400" />
              <div className="item d-flex">
                <img src="images/product-item8.png" className="img-fluid shadow-sm" alt="product item" />
                <div className="item-content ms-3">
                  <h6 className="mb-0 fw-bold"><a href="index.html">Starlight Sonata</a></h6>
                  <div className="review-content d-flex">
                    <p className="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    <div className="rating text-warning d-flex align-items-center">
                      <svg className="star star-fill">
              ...
              <hr />
              <div className="item d-flex">
                <img src="images/product-item9.png" className="img-fluid shadow-sm" alt="product item" />
                <div className="item-content ms-3">
                  <h6 className="mb-0 fw-bold"><a href="index.html">Tales of the Enchanted Forest</a></h6>
                  <div className="review-content d-flex">
                    <p className="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    <div className="rating text-warning d-flex align-items-center">
                      <svg className="star star-fill">
        ...
        <div className="col-md-6 mb-4 mb-lg-0 col-lg-3">
          <div className="on-sale border rounded-3 p-4">
            ...
            <div className="items-lists">
              <div className="item d-flex">
                <img src="images/product-item10.png" className="img-fluid shadow-sm" alt="product item" />
                <div className="item-content ms-3">
                  <h6 className="mb-0 fw-bold"><a href="index.html">The Phoenix Chronicles</a></h6>
                  <div className="review-content d-flex">
                    <p className="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    <div className="rating text-warning d-flex align-items-center">
                      <svg className="star star-fill">
              ...
              <hr className="gray-400" />
              <div className="item d-flex">
                <img src="images/product-item11.png" className="img-fluid shadow-sm" alt="product item" />
                <div className="item-content ms-3">
                  <h6 className="mb-0 fw-bold"><a href="index.html">Dreams of Avalon</a></h6>
                  <div className="review-content d-flex">
                    <p className="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    <div className="rating text-warning d-flex align-items-center">
                      <svg className="star star-fill">
              ...
              <hr />
              <div className="item d-flex">
                <img src="images/product-item12.png" className="img-fluid shadow-sm" alt="product item" />
                <div className="item-content ms-3">
                  <h6 className="mb-0 fw-bold"><a href="index.html">Legends of the Dragon Isles</a></h6>
                  <div className="review-content d-flex">
                    <p className="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    <div className="rating text-warning d-flex align-items-center">
                      <svg className="star star-fill">
      ...
      <div className="row">
        <div className="col-md-4">
          <div className="card mb-4 border-0 rounded-3 position-relative">
            <a href="index.html">
              <img src="images/category1.jpg" className="img-fluid rounded-3" alt="cart item" />
            </a><h6 className=" position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3"><a href="index.html" /><a href="index.html" className="text-white">Romance</a></h6>
          </div>
        </div>
        <div className="col-md-4">
          <div className="card text-center mb-4 border-0 rounded-3">
            <a href="index.html">
              <img src="images/category2.jpg" className="img-fluid rounded-3" alt="cart item" />
            </a><h6 className=" position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3"><a href="index.html" /><a href="index.html" className="text-white">Lifestyle</a></h6>
          </div>
        </div>
        <div className="col-md-4">
          <div className="card text-center mb-4 border-0 rounded-3">
            <a href="index.html">
              <img src="images/category3.jpg" className="img-fluid rounded-3" alt="cart item" />
            </a><h6 className=" position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3"><a href="index.html" /><a href="index.html" className="text-white">Recipe</a></h6>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-md-3 posts mb-4">
          <img src="images/post-item1.jpg" alt="post image" className="img-fluid rounded-3" />
          <a href="blog.html" className="fs-6 text-primary">Books</a>
          <h4 className="card-title mb-2 text-capitalize text-dark"><a href="index.html">10 Must-Read Books of the Year: Our Top Picks!</a></h4>
          <p className="mb-2">Dive into the world of cutting-edge technology with our latest blog post, where we highlight
            five essential gadge. <span><a className="text-decoration-underline text-black-50" href="index.html">Read More</a></span>
          </p>
        </div>
        <div className="col-md-3 posts mb-4">
          <img src="images/post-item2.jpg" alt="post image" className="img-fluid rounded-3" />
          <a href="blog.html" className="fs-6 text-primary">Books</a>
          <h4 className="card-title mb-2 text-capitalize text-dark"><a href="index.html">The Fascinating Realm of Science Fiction</a></h4>
          <p className="mb-2">Explore the intersection of technology and sustainability in our latest blog post. Learn about
            the innovative <span><a className="text-decoration-underline text-black-50" href="index.html">Read More</a></span> </p>
        </div>
        <div className="col-md-3 posts mb-4">
          <img src="images/post-item3.jpg" alt="post image" className="img-fluid rounded-3" />
          <a href="blog.html" className="fs-6 text-primary">Books</a>
          <h4 className="card-title mb-2 text-capitalize text-dark"><a href="index.html">Finding Love in the Pages of a Book</a></h4>
          <p className="mb-2">Stay ahead of the curve with our insightful look into the rapidly evolving landscape of
            wearable technology. <span><a className="text-decoration-underline text-black-50" href="index.html">Read More</a></span>
          </p>
        </div>
        <div className="col-md-3 posts mb-4">
          <img src="images/post-item4.jpg" alt="post image" className="img-fluid rounded-3" />
          <a href="blog.html" className="fs-6 text-primary">Books</a>
          <h4 className="card-title mb-2 text-capitalize text-dark"><a href="index.html">Reading for Mental Health: How Books Can Heal and Inspire</a></h4>
          <p className="mb-2">In today's remote work environment, productivity is key. Discover the top apps and tools that
            can help you stay <span><a className="text-decoration-underline text-black-50" href="index.html">Read More</a></span>
          </p>
        </div>
      </div>
    </div>
          ...
          <div className="row d-flex flex-wrap justify-content-between">
            ...
            <div className="col-lg-3 col-sm-6 pb-3">
              <div className="footer-menu contact-item ">
                ...
                <p>Do you have any queries or suggestions? <a href="mailto:" className="text-decoration-underline">chanpisey0022@gmail.com</a></p>
                <p>If you need support? Just give us a call. <a href="#" className="text-decoration-underline">+885 89609122
                    </a></p>
              </div>
            </div>
          </div>
