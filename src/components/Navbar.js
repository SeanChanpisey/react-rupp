...
const Navbar = ({ children }) => {
  ...
  ? cart.reduce((total, product) => total + (parseFloat(product.price) || 0), 0).toFixed(2)
  : "0.00";
  ...
  //   setTimeout(() => {
  //     setPaymentStatus(""); // Clear the message after 3 seconds
  //     handleCloseQRCode();
  //   }, 3000); // Close QR code popup after the message
  // };

  const initialOptions = {
    "client-id": "AT8II6wPoHcsSDNK5_fZGCjufBkpbn0x1gHJ4UDmhiEMWjg3VxjBUjE64SHfvFRx4rySDUSy9_tAjhaN",
    curency: "USD",
    intent: "capture",
  };
  ...
  const handleCheckoutClick = () => {
    // change qr to paypal account
    
    setShowQRCode(true);  // Show QR code when checkout button is clicked
  };

  // Function to close the QR code popup
  const handleCloseQRCode = () => {
    setShowQRCode(false);  // Hide QR code when the close button is clicked
  };
  return (
    <div> 
      {/* <header>
  ...
  <header id="header" className="site-header" style={{backgroundColor:"white"}}>
    <div className="top-info border-bottom d-none d-md-block ">
      <div className="container-fluid">
        <div className="row g-0">
          <div className="col-md-4">
            <p className="fs-6 my-2 text-center">Need any help? Call us <a href="#">+88589609122</a></p>
          </div>
          <div className="col-md-4 border-start border-end">
            <p className="fs-6 my-2 text-center">Summer sale discount off 60% off! <a className="text-decoration-underline" href="index.html">Shop Now</a></p>
          </div>
          <div className="col-md-4">
    ...
    <nav id="header-nav" className="navbar navbar-expand-lg py-3">
      <div className="container">
        ...
        <div className="offcanvas offcanvas-end" tabIndex={-1} id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
          ...
          <div className="offcanvas-body" >
            ...
            <li><Link style={{color:"black"}} to="/">Contact</Link></li>
            <li><Link style={{color:"black"}} to="/">About</Link></li>
            <li><Link style={{color:"black"}} to="/">Help</Link></li>
            </ul>
            <div className="user-items d-flex" >
              <ul className="d-flex justify-content-end list-unstyled mb-0">
                <li className="search-item pe-3">
                  <a href="#" className="search-button" style={{color:"black"}}>
                ...
                <li className="pe-3">
                  <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" style={{color:"black"}}>
                    <svg className="user">
                      <use xlinkHref="#user" />
                    </svg>
                  </a>
                  {/* Modal */}
                  <div className="modal fade" id="exampleModal" tabIndex={300} aria-labelledby="exampleModalLabel" aria-hidden="true" style={{zIndex:200}}>
                          ...
                          <div className="tabs-listing">
                            <nav>
                              <div className="nav nav-tabs d-flex justify-content-center" id="nav-tab" role="tablist">
                                <button className="nav-link text-capitalize active" id="nav-sign-in-tab" data-bs-toggle="tab" data-bs-target="#nav-sign-in" type="button" role="tab" aria-controls="nav-sign-in" aria-selected="true">Sign In</button>
                                <button className="nav-link text-capitalize" id="nav-register-tab" data-bs-toggle="tab" data-bs-target="#nav-register" type="button" role="tab" aria-controls="nav-register" aria-selected="false">Register</button>
                              </div>
                            </nav>
                            <div className="tab-content" id="nav-tabContent">
                              <div className="tab-pane fade active show" id="nav-sign-in" role="tabpanel" aria-labelledby="nav-sign-in-tab">
                                <div className="form-group py-3">
                                  <label className="mb-2" htmlFor="sign-in">Username or email address *</label>
                                  <input type="text" minLength={2} name="username" placeholder="Your Username" className="form-control w-100 rounded-3 p-3" required />
                                </div>
                                <div className="form-group pb-3">
                                  <label className="mb-2" htmlFor="sign-in">Password *</label>
                                  <input type="password" minLength={2} name="password" placeholder="Your Password" className="form-control w-100 rounded-3 p-3" required />
                                </div>
                              ...
                              <div className="tab-pane fade" id="nav-register" role="tabpanel" aria-labelledby="nav-register-tab">
                                <div className="form-group py-3">
                                  <label className="mb-2" htmlFor="register">Your email address *</label>
                                  <input type="text" minLength={2} name="username" placeholder="Your Email Address" className="form-control w-100 rounded-3 p-3" required />
                                </div>
                                <div className="form-group pb-3">
                                  <label className="mb-2" htmlFor="sign-in">Password *</label>
                                  <input type="password" minLength={2} name="password" placeholder="Your Password" className="form-control w-100 rounded-3 p-3" required />
                ...
                <li className="wishlist-dropdown dropdown pe-3">
                  <a href="#" className="dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false" style={{color:"black"}}>
                  ...
                  <div className="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3">
                    ...
                    <ul className="list-group mb-3">
                      ...
                      <li className="list-group-item bg-transparent d-flex justify-content-between lh-sm">
                        <div>
                          <h5>
                            <a href="index.html">The Emerald Crow</a>
                          </h5>
                    ...
                    <div className="d-flex flex-wrap justify-content-center">
                      ...
                      <a href="index.html" className="w-100 btn btn-primary" type="submit">View cart</a>
                    </div>
                  </div>
                </li>
                <li className="cart-dropdown dropdown">
                <Link  className="dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false" style={{color:"black"}} to="/cart">
                    <svg className="cart">
                      <use xlinkHref="#cart" /></svg>
                {cart.length > 0 && (
                  <span style={{marginLeft:"5px"}} className="badge bg-primary ms-1 ">{cart.length}</span>
                )}
        ...
        <div>
          ...
          <div className="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3">
            ...
            {/* Cart Items List */}
            <ul className="list-group mb-3" style={{height:"400px", overflow:"scroll" }}>
              {cart.map((product) => (
                <li
                  key={product.id}
            ...
            {/* Cart Actions */}
            <div className="d-flex flex-wrap justify-content-center">
              <Link to="/cart" className="w-100 btn btn-dark mb-1">
                View Cart
              </Link>
              <button 
          ...
          {/* Regular Cart View (for larger screens or alternative display) */}
          {/* <div className="mt-4  ">
      ...
      {showQRCode && (
        ...
        <PayPalScriptProvider>
          ...
          createOrder={(data, actions) => creatOrder(data, actions)}
        ...
        // <div
        //   className="qr-code-popup d-flex justify-content-right align-items-center bg-dark bg-opacity-90"
        //   style={{ zIndex: 99 }}
        // >
        //   <div className="popup-content bg-white p-4 rounded">
        //     <h5 className="text-center mb-3">Scan the QR Code to Pay</h5>
        //     <QRCodeSVG
      ...
      {paymentStatus && (
        <div
          className="payment-status text-center bg-success text-white p-3 rounded"
          style={{ position: "fixed", top: "20px", right: "20px", zIndex: 100 }}
        >
          {paymentStatus}
        </div>
        // adding paypal mothod
